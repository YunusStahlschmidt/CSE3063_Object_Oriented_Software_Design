    ...
    public static void main(String[] args) {
        ...
        for (Instance anInstance : dataset.getInstances()) {
            ...
            for (int i = 0; i < numberOfAssignmentsPerInstance; i++) {
                ...
                endDate = new Date();
                // System.out.println();
                // System.out.println(String.format("Instance Id: %d", newLabelAssignment.getInstanceId()));
                // System.out.println("Assigned Label Id: " + newLabelAssignment.getAssignedLabelId());
                // System.out.println("User Id: " + newLabelAssignment.getUserId());
                // System.out.println("Date: " + newLabelAssignment.getDate());
