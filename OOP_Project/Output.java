...
public class Output {
    ...
    public Output(long datasetId, String datasetName, long maximumNumberOfLabelsPerInstance, JSONArray classLabels,
            JSONArray instances, JSONArray classLabelAssignments, JSONArray users) {
